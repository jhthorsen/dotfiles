...
bindkey('n', '<leader>fp', function() builtin.find_files({find_command = {'find-files-cached', '..'}}) end, {desc = 'desc'})
bindkey('n', '<leader>fr', function() builtin.find_files({find_command = {'find-files-cached', '-r', '..'}}) end, {desc = 'desc'})
