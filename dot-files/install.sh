...
# .zshrc dependencies
install_file $ROOT_DIR/path.sh $CONFIG/00-path.sh
install_file $ROOT_DIR/aliases.sh $CONFIG/10-aliases.sh
install_file $ROOT_DIR/history.sh $CONFIG/10-history.sh
